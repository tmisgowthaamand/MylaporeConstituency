...
const inputPath = path.join(__dirname, 'public', 'bee77a3b-4e4d-4270-8f9d-386950808945.png');
const outputPath = path.join(__dirname, 'public', 'bee77a3b-4e4d-4270-8f9d-386950808945.png');
